...
for portrait_data in portraits:
    ...
    emotion = onto[portrait_data["emotion"].capitalize()]
    age = onto[str(portrait_data["age"])]
    race = onto[portrait_data["race"].replace(" ", "_").capitalize()]
    painter = onto[portrait_data["painter"]]
